...
//	std::cout << "merge keys: " << a->size() << ", " << b->size() << std::endl;
	...
	hiaux::hashtable<uint64_t, int> keys_map;
	...
	hiaux::hashtable<uint64_t, int>::iterator it = keys_map.begin();
	hiaux::hashtable<uint64_t, int>::iterator keys_map_end = keys_map.end(); 
